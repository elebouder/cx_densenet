...
root_dir = "/home/elebouder/Data/landsat/"
...
flags.DEFINE_string('dataset_dir', root_dir + "training_clips/split", 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', root_dir + "lsat", 'String: The output filename to name your TFRecord file')

# train images file to collect training set
flags.DEFINE_string('train_anno_file', root_dir + "train_llbl.txt", 'String: the path to the train anno txt file')

# test images file to collect val set
flags.DEFINE_string('test_anno_file', root_dir + "test_llbl.txt", 'String: the path to the test anno txt file')
